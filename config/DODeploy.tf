...
provider "kubernetes" {
  host  = digitalocean_kubernetes_cluster.kubernetes-api-cluster.endpoint
...
provider "helm" {
  kubernetes {
    host                   = digitalocean_kubernetes_cluster.kubernetes-api-cluster.endpoint
    token                  = digitalocean_kubernetes_cluster.kubernetes-api-cluster.kube_config[0].token
    cluster_ca_certificate = base64decode(digitalocean_kubernetes_cluster.kubernetes-api-cluster.kube_config[0].cluster_ca_certificate)
  }
}
